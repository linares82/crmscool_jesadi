...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
		...
		Route::model('impresionComprobanteEs', 'App\ImpresionComprobanteE');// generated by scaffold - ImpresionComprobanteE
		Route::model('hCalificacions', 'App\HCalificacion');// generated by scaffold - HCalificacion
    }
