    ...
    <div class="datagrid">
        ...
        <table class="table table-condensed table-striped">
            ...
            <tbody>
                ...
                @if(($concepto<>$registro->caja_concepto_id and $concepto<>0) or ($forma_pago<>$registro->forma_pago_id and $forma_pago<>0) and !$loop->first)
                        <tr>
                ...
                @if($forma_pago<>$registro->forma_pago_id and !$loop->first)
                    <tr>
