                ...
                @if($grupo0<>$r->grupo)
                    ...
                    <!--<div style="page-break-after:always;"></div>-->
                        ...
                        <tr>
                            ...
                            <th class="altura"><strong>Plantel</strong></th>
                            <th class="altura"><strong>Grado</strong></th>
                            <th class="altura"><strong>Lectivo</strong></th>
                            <th class="altura"><strong>Grupo</strong></th>
                            <th class="altura"><strong>Materia</strong></th>
                            <th class="altura"><strong>Instructor</strong></th>
