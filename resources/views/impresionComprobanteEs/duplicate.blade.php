...
@section('header')
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-duplicate"></i> @yield('impresionComprobanteEsAppTitle') / Duplicar {{$impresionComprobanteE->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($impresionComprobanteE, array('route' => array('impresionComprobanteEs.store'))) !!}
